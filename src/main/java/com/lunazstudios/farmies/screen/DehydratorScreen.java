...
public class DehydratorScreen extends AbstractContainerScreen<DehydratorMenu> {
    private static final ResourceLocation GUI_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(Farmies.MOD_ID,"textures/gui/dehydrator/dehydrator_gui.png");
    private static final ResourceLocation ARROW_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(Farmies.MOD_ID,"textures/gui/dehydrator/arrow_progress.png");
    private EnergyDisplayTooltipArea energyInfoArea;

    public DehydratorScreen(DehydratorMenu abstractContainerMenu, Inventory inventory, Component component) {
