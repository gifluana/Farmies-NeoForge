...
import com.lunazstudios.farmies.item.ScytheItem;
...
public class FItems {
   ...
   public static final DeferredItem<Item> STRAWBERRY = ITEMS.register("strawberry", () -> new Item(new Item.Properties().food(FFoodProperties.STRAWBERRY)));
    ...
    public static final DeferredItem<Item> DRIED_RED_BELLPEPPER = ITEMS.register("dried_red_bellpepper", () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> PAPRIKA = ITEMS.register("paprika", () -> new Item(new Item.Properties()));
